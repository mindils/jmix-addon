...
@PropertySource(name = "com.company.add", value = "classpath:/com/company/add/module.properties")
public class AddConfiguration {

    @Bean("add_AddViewControllers")
    public ViewControllersConfiguration screens(
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.add"));
    ...
    public ActionsConfiguration actions(
        ...
        actions.setBasePackages(Collections.singletonList("com.company.add"));
        return actions;
    }
}
